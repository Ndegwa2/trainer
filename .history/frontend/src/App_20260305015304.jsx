...
function App() {
  ...
  const fetchTDEE = async () => {
    try {
      const response = await axios.get(API_ENDPOINTS.tdee);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post(API_ENDPOINTS.dailyLog, {
        ...stats,
  ...
  const handleMealSubmit = async () => {
    ...
    try {
      const response = await axios.post(API_ENDPOINTS.logMeal, {
  ...
  const fetchMealPlan = async () => {
    ...
    try {
      const response = await axios.get(API_ENDPOINTS.mealPlan);
  ...
  const fetchProgressReport = async () => {
    ...
    try {
      const response = await axios.get(`${API_ENDPOINTS.progressReport}?days=7`);
  ...
  const fetchNutritionAdvice = async () => {
    ...
    try {
      const response = await axios.get(API_ENDPOINTS.nutritionAdvice);
              ...
              <CardContent>
                ...
                <Button
                  onClick={async () => {
                    ...
                    if (cal > 0) {
                      try {
                        await axios.post(API_ENDPOINTS.logMeal, {
